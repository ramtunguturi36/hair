const AnalysisPageStyles = {
  container: "min-h-screen flex items-center justify-center bg-brand-surface text-brand-textDark relative overflow-hidden isolate",
  backgroundCircles: "absolute inset-0 flex items-center justify-center -z-10",
  circle1: "w-[600px] h-[600px] rounded-full bg-accent-purple/10 blur-[120px] animate-pulse-glow mix-blend-multiply",
  circle2: "w-[500px] h-[500px] rounded-full bg-accent-cyan/10 blur-[120px] animate-pulse-glow animation-delay-2000 mix-blend-multiply absolute top-1/4 right-1/4",
  ...
  startButton: "btn-primary text-xl px-14 py-5 shadow-glow-purple z-30",
};
